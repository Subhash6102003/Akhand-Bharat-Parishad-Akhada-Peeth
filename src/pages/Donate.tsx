      ...
      <main className="flex-grow py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <div className="form-element bg-white dark:bg-background-dark p-6 rounded-xl border border-primary/10 shadow-sm">
            ...
            <div className="form-element bg-primary/5 dark:bg-primary/10 p-6 rounded-xl border border-primary/20 flex flex-col items-center text-center">
          ...
          <div ref={formRef} className="lg:col-span-7">
            <div className="bg-white dark:bg-background-dark rounded-2xl shadow-xl border border-gray-100 dark:border-primary/10 overflow-hidden">
              ...
              <div className="p-6 sm:p-8">
                ...
                <form className="space-y-8">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
                      {[500, 1000, 2500].map((amt) => (
                        <button
                          ...
                          type="button"
                        >
                          <span className={`font-bold text-lg ${amount === amt ? 'text-primary' : 'text-gray-600 dark:text-gray-300'}`}>
                            ₹{amt}
                          </span>
                        </button>
                      ))}
                      <div className="relative">
                        ...
                        <input
                          className="w-full h-full pl-7 pr-2 py-3 bg-gray-50 dark:bg-black/20 border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary text-sm font-semibold"
                          placeholder="Custom"
                          type="number"
                  ...
                  <div className="form-element pt-2">
                    <button
                      className="w-full bg-primary hover:bg-orange-600 text-white font-bold py-4 px-6 rounded-xl shadow-lg shadow-primary/30 transform transition hover:-translate-y-0.5 active:translate-y-0 flex items-center justify-center gap-2 text-lg"
                      type="submit"
                    >
